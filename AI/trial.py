...
# Load dataset
df = pd.read_csv("C:\\Users\\Dakshyani Murari\\OneDrive\\Desktop\\spend smart GIT\\SpendSmart\\AI\\data")
...
# Test items
test_items = ["roll", "Shahi paneer", "paneer", "biryani", "auto","hostel accomodation", "toothbrush", "shaving cream"]
